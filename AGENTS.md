...
## 專案速覽
- **技術棧**：Laravel 6.0 LTS（PHP 7.2-7.4）、MariaDB 10.3.39、Blade、Vue 3（透過 `laravel-mix` 編譯）、Bootstrap/AdminLTE。
- **數據庫環境**：
...
- **日期/時間處理**：使用 Carbon 2.x（Laravel 6.0 要求）；API 與 Carbon 1.x 基本兼容。
- **主要資料夾**：
