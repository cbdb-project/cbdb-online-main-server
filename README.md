...
- **Laravel**: 8.83 LTS (已從 8.0 升級，參見 [UPGRADE.md](./UPGRADE.md))
- **數據庫**: MariaDB 10.3.39 (Debian)
- **Web Server**: Caddy
- **Node.js**: 12.x

⚠️ **重要**：本專案現已升級到 Laravel 8.83 並要求 PHP 8.1+。**建議使用 PHP 8.4** 以獲得最佳性能和安全性。雖然 Laravel 8.83 官方僅測試到 PHP 8.1，但經測試 PHP 8.4 可正常運行。
