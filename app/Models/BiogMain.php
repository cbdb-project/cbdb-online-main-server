...
class BiogMain extends Model {
    ...
    public function biog_addresses() {
        return $this->hasMany('App\Models\BiogAddr', 'c_personid', 'c_personid')->orderBy('c_sequence');
    }

    public function altnames() {
        return $this->belongsToMany('App\Models\AltnameCode', 'ALTNAME_DATA', 'c_personid', 'c_alt_name_type_code')->withPivot('c_alt_name', 'c_alt_name_chn', 'c_alt_name_type_code', 'c_sequence')->orderBy(DB::raw('CASE WHEN c_sequence IS NULL THEN 1 ELSE 0 END, c_sequence'), 'ASC');
    }

    public function texts() {
        return $this->belongsToMany('App\Models\TextCode', 'BIOG_TEXT_DATA', 'c_personid', 'c_textid')->withPivot('c_textid', 'c_role_id');
    }
    ...
    public function kinship() {
        return $this->belongsToMany('App\Models\KinshipCode', 'KIN_DATA', 'c_personid', 'c_kin_code')->withPivot('c_personid', 'c_kin_id', 'c_kin_code');
    }
    ...
    public function assoc() {
        return $this->belongsToMany('App\Models\AssocCode', 'ASSOC_DATA', 'c_personid', 'c_assoc_code')->withPivot('c_assoc_id', 'c_kin_code', 'c_kin_id', 'c_assoc_kin_code', 'c_assoc_kin_id', 'c_text_title');
    }
    ...
    public function inst() {
        return $this->belongsToMany('App\Models\BiogInstCode', 'BIOG_INST_DATA', 'c_personid', 'c_bi_role_code')->withPivot('c_bi_begin_year', 'c_bi_end_year', 'c_inst_code', 'c_inst_name_code');
    }
