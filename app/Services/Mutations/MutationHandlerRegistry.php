...
class MutationHandlerRegistry {
    ...
    public function __construct(
        ...
        OfficeImportHandler $officeImportHandler,
        OfficeUpdateHandler $officeUpdateHandler,
        OfficeDeleteHandler $officeDeleteHandler,
        SocialInstituteImportHandler $socialInstituteImportHandler,
        SocialInstituteUpdateHandler $socialInstituteUpdateHandler,
        SocialInstituteDeleteHandler $socialInstituteDeleteHandler,
        ...
        $this->handlers = [
            ...
            $officeUpdateHandler,
            $officeDeleteHandler,
            $socialInstituteImportHandler,
            $socialInstituteUpdateHandler,
            $socialInstituteDeleteHandler,
