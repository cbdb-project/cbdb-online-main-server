...
CREATE TABLE `ADDR_BELONGS_DATA` (
  ...
  CONSTRAINT `ADDR_BELONGS_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ADDR_BELONGS_DATA_ibfk_2` FOREIGN KEY (`c_belongs_to`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ADDR_BELONGS_DATA_ibfk_3` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ALTNAME_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `ALTNAME_DATA_ibfk_1` FOREIGN KEY (`c_alt_name_type_code`) REFERENCES `ALTNAME_CODES` (`c_name_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ALTNAME_DATA_ibfk_2` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ALTNAME_DATA_ibfk_3` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `APPOINTMENT_CODE_TYPE_REL` (
  ...
  CONSTRAINT `APPOINTMENT_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_appt_code`) REFERENCES `APPOINTMENT_CODES` (`c_appt_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `APPOINTMENT_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_appt_type_code`) REFERENCES `APPOINTMENT_TYPES` (`c_appt_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `ASSOC_CODES` (
  ...
  CONSTRAINT `ASSOC_CODES_ibfk_1` FOREIGN KEY (`c_assoc_pair2`) REFERENCES `ASSOC_CODES` (`c_assoc_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ASSOC_CODE_TYPE_REL` (
  ...
  CONSTRAINT `ASSOC_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_assoc_code`) REFERENCES `ASSOC_CODES` (`c_assoc_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_assoc_type_code`) REFERENCES `ASSOC_TYPES` (`c_assoc_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ASSOC_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `ASSOC_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_10` FOREIGN KEY (`c_tertiary_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_11` FOREIGN KEY (`c_topic_code`) REFERENCES `SCHOLARLYTOPIC_CODES` (`c_topic_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_12` FOREIGN KEY (`c_assoc_claimer_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_13` FOREIGN KEY (`c_assoc_code`) REFERENCES `ASSOC_CODES` (`c_assoc_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_14` FOREIGN KEY (`c_assoc_fy_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_15` FOREIGN KEY (`c_assoc_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_16` FOREIGN KEY (`c_assoc_kin_code`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_17` FOREIGN KEY (`c_assoc_kin_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_18` FOREIGN KEY (`c_assoc_fy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_19` FOREIGN KEY (`c_assoc_fy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_2` FOREIGN KEY (`c_inst_name_code`) REFERENCES `SOCIAL_INSTITUTION_NAME_CODES` (`c_inst_name_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_3` FOREIGN KEY (`c_inst_code`) REFERENCES `SOCIAL_INSTITUTION_CODES` (`c_inst_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_4` FOREIGN KEY (`c_kin_code`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_5` FOREIGN KEY (`c_kin_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_6` FOREIGN KEY (`c_litgenre_code`) REFERENCES `LITERARYGENRE_CODES` (`c_lit_genre_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_7` FOREIGN KEY (`c_occasion_code`) REFERENCES `OCCASION_CODES` (`c_occasion_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_8` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ASSOC_DATA_ibfk_9` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BIOG_ADDR_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_10` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_2` FOREIGN KEY (`c_addr_type`) REFERENCES `BIOG_ADDR_CODES` (`c_addr_type`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_3` FOREIGN KEY (`c_fy_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_4` FOREIGN KEY (`c_fy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_5` FOREIGN KEY (`c_fy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_6` FOREIGN KEY (`c_ly_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_7` FOREIGN KEY (`c_ly_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_8` FOREIGN KEY (`c_ly_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_ADDR_DATA_ibfk_9` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BIOG_INST_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `BIOG_INST_DATA_ibfk_1` FOREIGN KEY (`c_bi_by_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_2` FOREIGN KEY (`c_bi_by_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_3` FOREIGN KEY (`c_bi_ey_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_4` FOREIGN KEY (`c_bi_ey_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_5` FOREIGN KEY (`c_bi_role_code`) REFERENCES `BIOG_INST_CODES` (`c_bi_role_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_6` FOREIGN KEY (`c_inst_name_code`) REFERENCES `SOCIAL_INSTITUTION_NAME_CODES` (`c_inst_name_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_7` FOREIGN KEY (`c_inst_code`) REFERENCES `SOCIAL_INSTITUTION_CODES` (`c_inst_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_8` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_INST_DATA_ibfk_9` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BIOG_MAIN` (
  ...
  CONSTRAINT `BIOG_MAIN_ibfk_1` FOREIGN KEY (`c_by_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_10` FOREIGN KEY (`c_ethnicity_code`) REFERENCES `ETHNICITY_TRIBE_CODES` (`c_ethnicity_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_11` FOREIGN KEY (`c_fl_ey_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_12` FOREIGN KEY (`c_fl_ly_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_13` FOREIGN KEY (`c_household_status_code`) REFERENCES `HOUSEHOLD_STATUS_CODES` (`c_household_status_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_2` FOREIGN KEY (`c_by_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_3` FOREIGN KEY (`c_by_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_4` FOREIGN KEY (`c_choronym_code`) REFERENCES `CHORONYM_CODES` (`c_choronym_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_5` FOREIGN KEY (`c_death_age_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_6` FOREIGN KEY (`c_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_7` FOREIGN KEY (`c_dy_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_8` FOREIGN KEY (`c_dy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_MAIN_ibfk_9` FOREIGN KEY (`c_dy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BIOG_SOURCE_DATA` (
  ...
  CONSTRAINT `BIOG_SOURCE_DATA_ibfk_1` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `BIOG_SOURCE_DATA_ibfk_2` FOREIGN KEY (`c_textid`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BIOG_TEXT_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `TEXT_DATA_ibfk_1` FOREIGN KEY (`c_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_DATA_ibfk_2` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_DATA_ibfk_3` FOREIGN KEY (`c_range_code`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_DATA_ibfk_4` FOREIGN KEY (`c_role_id`) REFERENCES `TEXT_ROLE_CODES` (`c_role_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_DATA_ibfk_5` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_DATA_ibfk_6` FOREIGN KEY (`c_textid`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ENTRY_CODE_TYPE_REL` (
  ...
  CONSTRAINT `ENTRY_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_entry_code`) REFERENCES `ENTRY_CODES` (`c_entry_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_entry_type`) REFERENCES `ENTRY_TYPES` (`c_entry_type`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ENTRY_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `ENTRY_DATA_ibfk_1` FOREIGN KEY (`c_assoc_code`) REFERENCES `ASSOC_CODES` (`c_assoc_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_10` FOREIGN KEY (`c_parental_status`) REFERENCES `PARENTAL_STATUS_CODES` (`c_parental_status_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_11` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_12` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_2` FOREIGN KEY (`c_assoc_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_3` FOREIGN KEY (`c_entry_code`) REFERENCES `ENTRY_CODES` (`c_entry_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_4` FOREIGN KEY (`c_entry_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_5` FOREIGN KEY (`c_inst_name_code`) REFERENCES `SOCIAL_INSTITUTION_NAME_CODES` (`c_inst_name_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_6` FOREIGN KEY (`c_inst_code`) REFERENCES `SOCIAL_INSTITUTION_CODES` (`c_inst_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_7` FOREIGN KEY (`c_kin_code`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_8` FOREIGN KEY (`c_kin_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `ENTRY_DATA_ibfk_9` FOREIGN KEY (`c_nianhao_id`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `EVENTS_ADDR` (
  ...
  CONSTRAINT `EVENTS_ADDR_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_ADDR_ibfk_2` FOREIGN KEY (`c_day_ganzhi`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_ADDR_ibfk_3` FOREIGN KEY (`c_event_record_id`) REFERENCES `EVENT_CODES` (`c_event_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_ADDR_ibfk_4` FOREIGN KEY (`c_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_ADDR_ibfk_5` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_ADDR_ibfk_6` FOREIGN KEY (`c_yr_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `EVENTS_DATA` (
  ...
  KEY `c_source` (`c_source`),
  KEY `c_yr_range` (`c_yr_range`),
  CONSTRAINT `EVENTS_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_2` FOREIGN KEY (`c_day_ganzhi`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_3` FOREIGN KEY (`c_event_code`) REFERENCES `EVENT_CODES` (`c_event_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_4` FOREIGN KEY (`c_event_record_id`) REFERENCES `EVENT_CODES` (`c_event_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_5` FOREIGN KEY (`c_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_6` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_7` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENTS_DATA_ibfk_8` FOREIGN KEY (`c_yr_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `EVENT_CODES` (
  ...
  KEY `c_ly_range` (`c_ly_range`),
  KEY `c_source` (`c_source`),
  CONSTRAINT `EVENT_CODES_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_2` FOREIGN KEY (`c_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_3` FOREIGN KEY (`c_fy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_4` FOREIGN KEY (`c_fy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_5` FOREIGN KEY (`c_ly_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_6` FOREIGN KEY (`c_ly_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `EVENT_CODES_ibfk_7` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `KINSHIP_CODES` (
  ...
  CONSTRAINT `KINSHIP_CODES_ibfk_1` FOREIGN KEY (`c_kin_pair1`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `KINSHIP_CODES_ibfk_2` FOREIGN KEY (`c_kin_pair2`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `KIN_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `KIN_DATA_ibfk_1` FOREIGN KEY (`c_kin_code`) REFERENCES `KINSHIP_CODES` (`c_kincode`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `KIN_DATA_ibfk_2` FOREIGN KEY (`c_kin_id`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `KIN_DATA_ibfk_3` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `KIN_DATA_ibfk_4` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `NIAN_HAO` (
  ...
  KEY `c_dy` (`c_dy`),
  CONSTRAINT `NIAN_HAO_ibfk_1` FOREIGN KEY (`c_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OFFICE_CODES` (
  ...
  KEY `c_dy` (`c_dy`),
  KEY `c_source` (`c_source`),
  CONSTRAINT `OFFICE_CODES_ibfk_1` FOREIGN KEY (`c_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `OFFICE_CODES_ibfk_2` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OFFICE_CODE_TYPE_REL` (
  ...
  CONSTRAINT `OFFICE_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_office_id`) REFERENCES `OFFICE_CODES` (`c_office_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `OFFICE_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_office_tree_id`) REFERENCES `OFFICE_TYPE_TREE` (`c_office_type_node_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OFFICE_TYPE_TREE` (
  ...
  CONSTRAINT `OFFICE_TYPE_TREE_ibfk_1` FOREIGN KEY (`c_parent_id`) REFERENCES `OFFICE_TYPE_TREE` (`c_office_type_node_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POSSESSION_ADDR` (
  ...
  CONSTRAINT `POSSESSION_ADDR_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_ADDR_ibfk_2` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_ADDR_ibfk_3` FOREIGN KEY (`c_possession_record_id`) REFERENCES `POSSESSION_DATA` (`c_possession_record_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POSSESSION_DATA` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `POSSESSION_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_2` FOREIGN KEY (`c_measure_code`) REFERENCES `MEASURE_CODES` (`c_measure_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_3` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_4` FOREIGN KEY (`c_possession_act_code`) REFERENCES `POSSESSION_ACT_CODES` (`c_possession_act_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_5` FOREIGN KEY (`c_possession_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_6` FOREIGN KEY (`c_possession_yr_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSSESSION_DATA_ibfk_7` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POSTED_TO_ADDR_DATA` (
  ...
  CONSTRAINT `POSTED_TO_ADDR_DATA_ibfk_1` FOREIGN KEY (`c_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_ADDR_DATA_ibfk_2` FOREIGN KEY (`c_office_id`) REFERENCES `OFFICE_CODES` (`c_office_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_ADDR_DATA_ibfk_3` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_ADDR_DATA_ibfk_4` FOREIGN KEY (`c_posting_id`) REFERENCES `POSTING_DATA` (`c_posting_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POSTED_TO_OFFICE_DATA` (
  ...
  KEY `c_ly_range` (`c_ly_range`),
  KEY `c_source` (`c_source`),
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_1` FOREIGN KEY (`c_appt_type_code`) REFERENCES `APPOINTMENT_CODES` (`c_appt_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_10` FOREIGN KEY (`c_ly_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_11` FOREIGN KEY (`c_ly_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_12` FOREIGN KEY (`c_office_category_id`) REFERENCES `OFFICE_CATEGORIES` (`c_office_category_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_13` FOREIGN KEY (`c_office_id`) REFERENCES `OFFICE_CODES` (`c_office_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_14` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_15` FOREIGN KEY (`c_posting_id`) REFERENCES `POSTING_DATA` (`c_posting_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_16` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_2` FOREIGN KEY (`c_assume_office_code`) REFERENCES `ASSUME_OFFICE_CODES` (`c_assume_office_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_3` FOREIGN KEY (`c_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_4` FOREIGN KEY (`c_fy_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_5` FOREIGN KEY (`c_fy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_6` FOREIGN KEY (`c_fy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_7` FOREIGN KEY (`c_inst_name_code`) REFERENCES `SOCIAL_INSTITUTION_NAME_CODES` (`c_inst_name_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_8` FOREIGN KEY (`c_inst_code`) REFERENCES `SOCIAL_INSTITUTION_CODES` (`c_inst_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `POSTED_TO_OFFICE_DATA_ibfk_9` FOREIGN KEY (`c_ly_day_gz`) REFERENCES `GANZHI_CODES` (`c_ganzhi_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POSTING_DATA` (
  ...
  CONSTRAINT `POSTING_DATA_ibfk_1` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SOCIAL_INSTITUTION_ADDR` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `SOCIAL_INSTITUTION_ADDR_ibfk_1` FOREIGN KEY (`c_inst_addr_id`) REFERENCES `ADDR_CODES` (`c_addr_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_ADDR_ibfk_2` FOREIGN KEY (`c_inst_addr_type_code`) REFERENCES `SOCIAL_INSTITUTION_ADDR_TYPES` (`c_inst_addr_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_ADDR_ibfk_3` FOREIGN KEY (`c_inst_code`) REFERENCES `SOCIAL_INSTITUTION_CODES` (`c_inst_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_ADDR_ibfk_4` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SOCIAL_INSTITUTION_CODES` (
  ...
  KEY `c_source` (`c_source`),
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_1` FOREIGN KEY (`c_by_nianhao_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_2` FOREIGN KEY (`c_by_year_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_3` FOREIGN KEY (`c_ey_nianhao_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_4` FOREIGN KEY (`c_ey_year_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_5` FOREIGN KEY (`c_inst_begin_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_6` FOREIGN KEY (`c_inst_floruit_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_7` FOREIGN KEY (`c_inst_name_code`) REFERENCES `SOCIAL_INSTITUTION_NAME_CODES` (`c_inst_name_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_8` FOREIGN KEY (`c_inst_type_code`) REFERENCES `SOCIAL_INSTITUTION_TYPES` (`c_inst_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SOCIAL_INSTITUTION_CODES_ibfk_9` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `STATUS_CODE_TYPE_REL` (
  ...
  CONSTRAINT `STATUS_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_status_code`) REFERENCES `STATUS_CODES` (`c_status_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_status_type_code`) REFERENCES `STATUS_TYPES` (`c_status_type_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `STATUS_DATA` (
  ...
  KEY `c_ly_range` (`c_ly_range`),
  KEY `c_source` (`c_source`),
  CONSTRAINT `STATUS_DATA_ibfk_1` FOREIGN KEY (`c_fy_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_2` FOREIGN KEY (`c_fy_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_3` FOREIGN KEY (`c_ly_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_4` FOREIGN KEY (`c_ly_range`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_5` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_6` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `STATUS_DATA_ibfk_7` FOREIGN KEY (`c_status_code`) REFERENCES `STATUS_CODES` (`c_status_code`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TEXT_BIBLCAT_CODE_TYPE_REL` (
  ...
  CONSTRAINT `TEXT_BIBLCAT_CODE_TYPE_REL_ibfk_1` FOREIGN KEY (`c_text_cat_code`) REFERENCES `TEXT_BIBLCAT_CODES` (`c_text_cat_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_BIBLCAT_CODE_TYPE_REL_ibfk_2` FOREIGN KEY (`c_text_cat_type_id`) REFERENCES `TEXT_BIBLCAT_TYPES` (`c_text_cat_type_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TEXT_CODES` (
  ...
  CONSTRAINT `TEXT_CODES_ibfk_1` FOREIGN KEY (`c_bibl_cat_code`) REFERENCES `TEXT_BIBLCAT_CODES` (`c_text_cat_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_10` FOREIGN KEY (`c_text_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_11` FOREIGN KEY (`c_text_range_code`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_2` FOREIGN KEY (`c_extant`) REFERENCES `EXTANT_CODES` (`c_extant_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_7` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_8` FOREIGN KEY (`c_text_country`) REFERENCES `COUNTRY_CODES` (`c_country_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_CODES_ibfk_9` FOREIGN KEY (`c_text_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TEXT_INSTANCE_DATA` (
  ...
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_1` FOREIGN KEY (`c_textid`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_2` FOREIGN KEY (`c_pub_nh_code`) REFERENCES `NIAN_HAO` (`c_nianhao_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_3` FOREIGN KEY (`c_pub_country`) REFERENCES `COUNTRY_CODES` (`c_country_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_4` FOREIGN KEY (`c_pub_dy`) REFERENCES `DYNASTIES` (`c_dy`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_5` FOREIGN KEY (`c_pub_range_code`) REFERENCES `YEAR_RANGE_CODES` (`c_range_code`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `TEXT_INSTANCE_DATA_ibfk_6` FOREIGN KEY (`c_source`) REFERENCES `TEXT_CODES` (`c_textid`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operations` (
  ...
  CONSTRAINT `c_personid` FOREIGN KEY (`c_personid`) REFERENCES `BIOG_MAIN` (`c_personid`) ON DELETE RESTRICT ON UPDATE CASCADE
