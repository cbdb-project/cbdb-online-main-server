<template>
    <div class="">
        <div class="form-group">
            <div class="text-center">查询中国行政地理单位</div>
        ...
        <table class="table table-hover table-condensed">
            ...
            <tr v-for="item in names.data">
                ...
                <td>
                    <div class="btn-group">
                        <a type="button" class="btn btn-sm btn-info" :href="'/addrcodes/'+item.c_addr_id+'/edit'">edit</a>
...
<script>
    export default {
        ...
        methods: {
            searchByName(val = 1) {
                axios.post('/api/addrcode', {'q': this.q, 'page': val}).then(response => {
