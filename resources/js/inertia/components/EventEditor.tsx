...
const chipRemoveStyle: React.CSSProperties = { border: 'none', background: 'transparent', color: 'var(--info-subtle-foreground)', cursor: 'pointer', fontSize: '1rem', lineHeight: 1, padding: '0 2px' };
