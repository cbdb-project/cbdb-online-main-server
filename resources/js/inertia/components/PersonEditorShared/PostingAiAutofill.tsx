...
export default function PostingAiAutofill({ personId, extractEndpoint, aiModel, disabled = false, t, onApply, onClear }: Props) {
    ...
    return (
        <div style={cardStyle}>
            <div style={headerStyle}>
                <strong style={titleStyle}><i className="fas fa-wand-magic-sparkles" aria-hidden="true" style={{ marginRight: 6 }} />{tr('ai_offices_autofill', 'AI 智能填充（任官）')}</strong>
            </div>
