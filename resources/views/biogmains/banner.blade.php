...
<div class="text-center">
    ...
    <div class="row text-left">
        ...
        <div class="col-sm-2">
            <a href="{{ route('basicinformation.sources.index', ['id' => $basicinformation->c_personid]) }}"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;出處({{ $basicinformation->sources_count }})</a>
        </div>
    </div>
    <br>
</div>
