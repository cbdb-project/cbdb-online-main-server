...
@section('content')
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">{{ $readonly ? __('biogmains.basic_info_readonly') : __('biogmains.basic_info_title') }}</h3>
        </div>

        <div id='check_info' style='display:none;' class="alert alert-danger alert-dismissible">{{ __('biogmains.basicinfo_check_alert') }}</div>
        <div id='pinyin_info' style='display:none;' class="alert alert-success alert-dismissible">{{ __('biogmains.basicinfo_pinyin_alert') }}</div>
        ...
        <div class="card-body">
            <form id="basic-info-form" action="/basicinformation/{{ $basicinformation->c_personid }}"
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="c_surname_chn" class="col-sm-4 col-form-label">{{ __('biogmains.surname_chn') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="c_mingzi_chn" class="col-sm-4 col-form-label">{{ __('biogmains.mingzi_chn') }}</label>
                            <div class="col-sm-8">
                ...
                @if(!$readonly)
                    <div class="form-group row">
                        <div class="col-sm-4 offset-sm-2">
                            <button type="button" id="button_ajax_load" class="btn btn-info">{{ __('biogmains.generate_pinyin_btn') }}</button>
                        </div>
                    </div>
                @endif
                <div class="form-group row">
                    <label for="c_surname_proper" class="col-sm-2 col-form-label">{{ __('biogmains.foreign_surname') }}</label>
                    <div class="col-sm-4">
                    ...
                    <label for="c_mingzi_proper" class="col-sm-2 col-form-label">{{ __('biogmains.foreign_mingzi') }}</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <label for="c_surname_rm" class="col-sm-2 col-form-label">{{ __('biogmains.foreign_rm_surname') }}</label>
                    <div class="col-sm-4">
                    ...
                    <label for="c_mingzi_rm" class="col-sm-2 col-form-label">{{ __('biogmains.foreign_rm_mingzi') }}</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <div class="col-12 col-xl-3 mb-3 mb-xl-0">
                        <label for="c_name_chn" class="col-form-label">{{ __('biogmains.person_name_chn_label') }} (c_name_chn)</label>
                        <input type="text" name="c_name_chn" class="form-control" readonly
                               value="{{ $basicinformation->c_name_chn }}"
                               style="background-color: #f5f5f5; cursor: not-allowed;">
                        <span class="help-block">
                            <small class="text-muted">{{ __('biogmains.name_auto_hint') }}</small>
                        </span>
                    </div>
                    <div class="col-12 col-xl-3 mb-3 mb-xl-0">
                        <label for="c_name" class="col-form-label">{{ __('person.pinyin') }} (c_name)</label>
                        <input type="text" name="c_name" class="form-control" readonly
                               value="{{ $basicinformation->c_name }}"
                               style="background-color: #f5f5f5; cursor: not-allowed;">
                        <span class="help-block">
                            <small class="text-muted">{{ __('biogmains.pinyin_auto_hint') }}</small>
                        </span>
                    </div>
                    <div class="col-12 col-xl-3 mb-3 mb-xl-0">
                        <label for="c_name_proper" class="col-form-label">{{ __('biogmains.foreign_full_name') }} (c_name_proper)</label>
                        <input type="text" name="c_name_proper" class="form-control" readonly
                               value="{{ $basicinformation->c_name_proper }}"
                               style="background-color: #f5f5f5; cursor: not-allowed;">
                        <span class="help-block">
                            <small class="text-muted">{{ __('biogmains.foreign_full_auto_hint') }}</small>
                        </span>
                    </div>
                    <div class="col-12 col-xl-3">
                        <label for="c_name_rm" class="col-form-label">{{ __('biogmains.foreign_rm_full_name') }} (c_name_rm)</label>
                        <input type="text" name="c_name_rm" class="form-control" readonly
                               value="{{ $basicinformation->c_name_rm }}"
                               style="background-color: #f5f5f5; cursor: not-allowed;">
                        <span class="help-block">
                            <small class="text-muted">{{ __('biogmains.rm_auto_hint') }}</small>
                        </span>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="c_female" class="col-sm-2 col-form-label">{{ __('person.gender') }} (c_female)</label>
                    <div class="col-sm-4">
                        @php($selectedFemale = old('c_female', $basicinformation->c_female))
                        <select class="form-control select2" name="c_female" {{ $disabled }}>
                            <option value="NULL" {{ $selectedFemale === null || $selectedFemale === '' || $selectedFemale === 'NULL' ? 'selected' : '' }}>NULL-{{ __('common.no') }}
                            </option>
                            <option value="0" {{ (string) $selectedFemale === '0' ? 'selected' : '' }}>0-{{ __('person.male') }}
                            </option>
                            <option value="1" {{ (string) $selectedFemale === '1' ? 'selected' : '' }}>1-{{ __('person.female') }}
                            </option>
                        </select>
                    </div>
                    <label for="c_ethnicity_code" class="col-sm-2 col-form-label">{{ __('biogmains.choronym_field') }} / {{ __('person.tribe') }} (c_ethnicity_code)</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <label for="c_dy" class="col-sm-2 col-form-label">{{ __('person.dynasty') }} (c_dy)</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="c_firstyear" class="col-sm-2 col-form-label">{{ __('person.birth_year') }} (c_birthyear)</label>
                ...
                <div class="form-group row">
                    <label for="c_firstyear" class="col-sm-2 col-form-label">{{ __('person.death_year') }} (c_deathyear)</label>
                    <x-inline-time-fields
                ...
                <div class="form-group row">
                    <div class="col-12 col-xl-4 mb-3 mb-xl-0">
                        <label for="c_index_year" class="col-form-label">{{ __('person.index_year') }} (c_index_year)</label>
                        <input type="number" name="c_index_year" class="form-control @error('c_index_year') is-invalid @enderror" readonly
                               ...
                               style="background-color: #f5f5f5; cursor: not-allowed;">
                        <span class="help-block">
                            <small class="text-muted">{{ __('biogmains.auto_calc_hint') }}</small>
                        </span>
                        @error('c_index_year')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-xl-4 mb-3 mb-xl-0">
                        <label for="c_index_year_type_code" class="col-form-label">{{ __('biogmains.index_year_method') }} (c_index_year_type_code)</label>
                    ...
                    <div class="col-12 col-xl-4">
                        <label for="c_index_year_source_id" class="col-form-label">{{ __('biogmains.index_year_source_col') }} (c_index_year_source_id)</label>
                        <input type="text" name="" class="form-control" readonly
                ...
                <div class="form-group row">
                    <div class="col-12 col-xl-6 mb-3 mb-xl-0">
                        <label for="c_index_addr_id" class="col-form-label">{{ __('biogmains.index_addr') }} (c_index_addr_id)</label>
                        <input type="text" name="" class="form-control" readonly
                    ...
                    <div class="col-12 col-xl-6">
                        <label for="c_index_addr_type_code" class="col-form-label">{{ __('biogmains.index_addr_type') }} (c_index_addr_type_code)</label>
                        <input type="text" name="" class="form-control" readonly
                ...
                <div class="form-group row">
                    <label for="c_death_age" class="col-sm-2 col-form-label">{{ __('person.age_at_death') }} (c_death_age)</label>
                    <div class="col-sm-4">
                    ...
                    <label for="c_death_age_range" class="col-sm-2 col-form-label">{{ __('biogmains.range_label') }} (c_death_age_range)</label>
                    <div class="col-sm-4">
                        <select class="form-control select2" name="c_death_age_range" id="c_death_age_range" {{ $disabled }}>
                            <option value="" {{ $basicinformation->c_death_age_range === null ? 'selected' : '' }}>{{ __('biogmains.please_select') }}</option>
                ...
                <div class="form-group row">
                    <label for="c_fl_earliest_year"
                           class="col-sm-2 col-form-label">{{ __('person.active_from') }} (c_fl_earliest_year)</label>
                    <x-inline-time-fields
                        ...
                        :notesLabel="__('biogmains.fl_earliest_notes').' (c_fl_ey_notes)'"
                        :disabled="$readonly"
                    />
                </div>
                <div class="form-group row">
                    <label for="c_fl_latest_year"
                           class="col-sm-2 col-form-label">{{ __('person.active_until') }} (c_fl_latest_year)</label>
                    <x-inline-time-fields
                        ...
                        :notesLabel="__('biogmains.fl_latest_notes').' (c_fl_ly_notes)'"
                        :disabled="$readonly"
                    />
                </div>
                <div class="form-group row">
                    <label for="c_choronym_code" class="col-sm-2 col-form-label">{{ __('person.choronym') }} (c_choronym_code)</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="c_household_status_code" class="col-sm-2 col-form-label">{{ __('biogmains.household_field') }} (c_household_status_code)</label>
                    <div class="col-sm-10">
                ...
                @if(!$readonly)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="__proposal_comment" rows="3" placeholder="{{ __('biogmains.modification_note_placeholder') }}" {{ $disabled }}></textarea>
                ...
                @auth
                    @if(Auth::user()->isActive())
                        <div class="btn-group float-right">
                            <a href=""
                               onclick="
                                           var msg = {!! Js::from(__('biogmains.delete_confirm_js')) !!};
                                           if (confirm(msg)===true){
                                           ...
                                           "
                               class="btn btn-danger">{{ __('common.delete') }}</a>
...
onViteReady(function(){
    ...
    $(window).on('beforeunload', function(){
        ...
        if(c_mingzi_chn == '' || c_mingzi == '') {
            ...
            return {!! Js::from(__('biogmains.basicinfo_check_alert')) !!};
        }
    });
