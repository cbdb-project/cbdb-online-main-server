...
<form action="{{ $formAction }}" method="post">
    ...
    <div class="form-group row">
        <label for="c_bi_role_code" class="col-sm-2 col-form-label">{{ __('biogmains.socialinst_role') }} (c_bi_role_code)</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label for="c_bi_begin_year" class="col-sm-2 col-form-label">{{ __('biogmains.start_year') }} (firstyear)</label>
    ...
    <div class="form-group row">
        <label for="c_bi_end_year" class="col-sm-2 col-form-label">{{ __('biogmains.end_year') }} (lastyear)</label>
        <x-inline-time-fields
