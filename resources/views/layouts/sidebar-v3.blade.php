        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
                ...
                @php
                    ...
                    $codesMenuOpen = in_array($page_title, $codesPages, true);
                @endphp
                <li class="nav-item {{ $codesMenuOpen ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="/codes/ALTNAME_CODES" class="nav-link {{ in_array($page_title, ['ALTNAME_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-user-tag"></i>
                                <p>別名編碼表 <small>(ALTNAME_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/APPOINTMENT_CODES" class="nav-link {{ in_array($page_title, ['APPOINTMENT_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-briefcase"></i>
                                <p>任命類型編碼表 <small>(APPOINTMENT_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/TEXT_CODES" class="nav-link {{ in_array($page_title, ['TEXT_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book"></i>
                                <p>著作編碼表 <small>(TEXT_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/ADDR_CODES" class="nav-link {{ in_array($page_title, ['ADDR_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-map-marker-alt"></i>
                                <p>地址編碼表 <small>(ADDR_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/OFFICE_CODES" class="nav-link {{ in_array($page_title, ['OFFICE_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-id-badge"></i>
                                <p>任官編碼表 <small>(OFFICE_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/SOCIAL_INSTITUTION_CODES" class="nav-link {{ in_array($page_title, ['SOCIAL_INSTITUTION_CODES'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-university"></i>
                                <p>社會機構編碼表 <small>(SOCIAL_INSTITUTION_CODES)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/ADDR_BELONGS_DATA" class="nav-link {{ in_array($page_title, ['ADDR_BELONGS_DATA'], true) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-sitemap"></i>
                                <p>地址從屬表 <small>(ADDR_BELONGS_DATA)</small></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/codes/TEXT_INSTANCE_DATA" class="nav-link {{ in_array($page_title, ['TEXT_INSTANCE_DATA'], true) ? 'active' : '' }}">
                ...
                @php
                    ...
                    $viewsMenuOpen = in_array($page_title, $viewPages, true);
                @endphp
                ...
                @if(Auth::check() and Auth::user()->isAdmin())
                    @php
                        ...
                        $adminMenuOpen = in_array($page_title, $adminPages, true);
                    @endphp
                    <li class="nav-item {{ $adminMenuOpen ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('manage.index') }}" class="nav-link {{ in_array($page_title, ['用戶管理'], true) ? 'active' : '' }}">
